...
class CombinedLoss(nn.Module):
    def __init__(self, device):
        ...
        # orginal parameters    &   modified parameters 1   &   modified parameters 2
        self.alpha1 = 1.00      #   1.00                    &   1.00
        self.alpha2 = 0.06      #   0                       &   0
        self.alpha3 = 0.05      #   0                       &   0
        self.alpha4 = 0.5       #   0.5                     &   0
        self.alpha5 = 0.0083    #   0                       &   0
        self.alpha6 = 0.25      #   0.25                    &   0
